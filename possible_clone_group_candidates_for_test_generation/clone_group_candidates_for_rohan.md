...
<span style="color:red"> More tests could be generated by using different numerical parameters. </span>
...
Currently this is not refactorable, and shall be considered a good candidate for bug searching, especially in the case of division. </span>
...
<span style="color:red"> generate more tests with case non-sensitive, or with different strings containing special characters to have more possiblities to find bugs </span>
...
<span style="color:red"> Possible to generate more tests with varying file name for the binary file, or with encoding other than UTF8 </span>
...
<span style="color:red"> This clone group of varying urls in the test cases has a potential to generate more test cases for bug search in urls.</span>
...
<span style="color:red"> From the test generation perspective, there could be more tests by filling the info object with some values other than null. The purpose of testing may be different, but they are probably still considered as clones. </span>
...
<span style="color:red"> There are more ways to varying the linked list of *CompoundVariable* other than the difference in "template", and thus possible to generate more similar tests in this group. </span>
...
<span style="color:red">Many places within this clone pair may be investigated for bug search through random inputs testing.</span>
